    ...
    <div class="flex justify-between   container mx-auto">
        <div class="w-full lg:w-8/12">
            ...
            <div class="mt-6">
                <div class="max-w-4xl bg-white rounded-lg shadow-md">
                    <div>
                        <a href="{{ $article->path()}}"> <img class="object-cover w-full h-64 rounded-md" src="https://images.unsplash.com/photo-1464863979621-258859e62245?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=333&amp;q=80" alt="{{$article->title}}"></a>
                    </div>
                    <div class="px-10 py-6">
                        ...
                        <div class="mt-2">
                            <a href="{{ $article->path()}}" class="text-2xl text-gray-700 font-bold hover:underline">
                                {{$article->title}}</a>
                            <p class="mt-2 text-gray-600">{{ $article->excerpt}}
        ...
        <div class="-mx-8 w-4/12 hidden lg:block">
            ...
            <div class="mt-10 px-8">
                ...
                <div class="flex flex-col bg-white max-w-sm mx-auto rounded-lg shadow-md my-5">
                    <div><a href="{{$article->title}}">
                            <img class=" object-cover w-full  block md:hidden lg:block rounded-md h-64 md:h-32 m-4 md:m-0" src="https://images.unsplash.com/photo-1464863979621-258859e62245?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=333&amp;q=80" alt="{{$article->title}}">
                        </a>
                    </div>
